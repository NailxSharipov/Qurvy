...
impl Line {
    ...
    #[inline]
    pub(crate) fn split_at(&self, step: usize, split_factor: usize) -> IntPoint {
    ...
    #[inline]
    fn split_one_dimension_at(a: i64, b: i64, step: usize, split_factor: usize) -> i64 {
        let ab = b.wrapping_sub(a) as i128;
        let step = step as i128;
        let shift = split_factor as u32;

        let scaled = (ab * step) >> shift;
...
mod tests {
    ...
    #[test]
    fn test_00() {
        let m = Line::new(IntPoint::new(0, 0), IntPoint::new(0, 8))
            .split_at(1, 1);
    ...
    #[test]
    fn test_01() {
        let line = Line::new(IntPoint::new(0, 0), IntPoint::new(0, 8));
    ...
    #[test]
    fn test_02() {
        let line = Line::new(IntPoint::new(0, -4), IntPoint::new(0, 4));
        let m0 = line.split_at(0, 2);
        let m1 = line.split_at(1, 2);
        let m2 = line.split_at(2, 2);
        let m3 = line.split_at(3, 2);
